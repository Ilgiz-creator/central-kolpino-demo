...
initMotion({"hero": ".hero-copy > .eyebrow, .hero h1, .hero-description, .hero .button", "art": ".hero-art img", "reveal": ".section-head h2, .occasions article, .gather-title h2", "artStart": "scale(1.055)"});
})();
